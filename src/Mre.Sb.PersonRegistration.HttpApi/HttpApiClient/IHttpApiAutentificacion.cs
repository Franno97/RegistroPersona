...
namespace Mre.Sb.PersonRegistration.HttpApiClient
{
    public interface IHttpApiAutentificacion
    {
        ...
        Task<string> GetAccessTokenAsync(string identityClientName = null);
    }

    /// <summary>
    /// Basado en Volo.Abp.IdentityModel.IdentityModelAuthenticationService
    /// </summary>
    public class HttpApiAutentificacion : IHttpApiAutentificacion, ITransientDependency
    {
        ...
        public virtual async Task<string> GetAccessTokenAsync(string identityClientName) {
        ...
        protected virtual async Task<string> GetAccessTokenAsync(IdentityClientConfiguration configuration)
        {
